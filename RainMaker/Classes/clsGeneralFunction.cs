...
namespace RainMaker.Classes
{
    public class clsGeneralFunction
    {
        ...
        public DataTable GetOpportunityRevenueDetails(int OppRevnueID)
        {
            dynamic[,] para = {
                              {"@RevenueID",OppRevnueID }
                              };
            clsDBAccess objDBAcess = new clsDBAccess(constr, _eDBType);
            DataTable dt_GD = objDBAcess.SP_Datatable("Get_OpportunityRevenueDatail", para);
            return dt_GD;
        }
        ...
        public DataTable GetOpportunityDetailsEBU(int OppID)
        {
            dynamic[,] para = {
                              {"@OppID",OppID }
                              };
            clsDBAccess objDBAcess = new clsDBAccess(constr, _eDBType);
            DataTable dt_GD = objDBAcess.SP_Datatable("Get_OpportunityEBU", para);
            return dt_GD;
        }
        public DataTable GetOpportunityRevEBU(int OppID)

        {
            ...
            clsDBAccess objDBAcess = new clsDBAccess(constr, _eDBType);
            DataTable dt_GD = objDBAcess.SP_Datatable("Get_OpportunityRevEBU", para);
            return dt_GD;
        }
        ...
        public DataTable GetOpp(string  OppID)
        {
            dynamic[,] para = { 
            ...
            clsDBAccess objDBAcess = new clsDBAccess(constr, _eDBType);
            DataTable dt_GOS = objDBAcess.SP_Datatable("Get_Opp", para);
            return dt_GOS;
        }
