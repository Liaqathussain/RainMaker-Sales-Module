...
namespace RainMaker
{
    public partial class ComplainManager : System.Web.UI.Page
    {
        ...
        {
            //if (e.CommandName == "Complain Closure" || e.CommandName == "Follow Up" || e.CommandName == "Solving")
            //{
            ...
            //    //Session["ComplaintReceivedDate"] = item["ComplaintReceivedDate"].Text;
            //    //Session["LoggedBy"] = item["LoggedBy"].Text;
            //    //Session["ComplainStatus"] = item["ComplainStatus"].Text;
            //    //Session["ETTR"] = Convert.ToDateTime(item["ETTR"].Text);
            //    //Session["ETA"] = Convert.ToDateTime(item["ETA"].Text);
            //    //Session["Remarks"] = item["Remarks"].Text;
            ...
            if (e.CommandName == "Complain Closure" || e.CommandName == "Follow Up" || e.CommandName == "Solving" || e.CommandName == "View History" || e.CommandName == "Ticket No")
            {
                ...
                {
                    //if (ComplainStatusID.Equals(1) && click.Equals("Complain Closure"))
                    //{
                    //    Response.Redirect("~\\ComplainMisc.aspx?click=" + click);
                    //}

                    //if ((ComplainStatusID.Equals(4) || ComplainStatusID.Equals(2)) && !(click.Equals("Complain Closure")))
                    //{
                    //    Response.Redirect("~\\ComplainMisc.aspx?click=" + click);
                    //}
        ...
        private void SearchComplainCircuits()
        {
            try
            {
                ...
                (cmbTicketType.Text != "Please-Select" ? cmbTicketType.Text : ""),
                ...
                (cmbLoggedBy.Text != "Please-Select" ? cmbLoggedBy.Text : ""),
