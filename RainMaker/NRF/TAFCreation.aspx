<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="TAFCreation.aspx.cs" Inherits="RainMaker.NRF.TAFCreation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="page-wrapper">
        ...
        <div class="container">
            <%-- <div>
<telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" Skin="Office2007" ValidationGroup="ValidationProduct">
        <Items>
            ...
            <telerik:RadButton ID="btSave" OnClick="btSave_Click" Text="Save" runat="server">
            </telerik:RadButton>
            <asp:Label ID="lblSaveSuccessfully" Visible="false" runat="server" Text="Record Saved Successfully"></asp:Label>
                ...
                <td bgcolor="#03828A" style="font-family: Calibri;  font-weight: bold; color: #FFFFFF">
                   Technical Specification / Service Parameter
                            ...
                            <td align="right">
                                ...
                                <td>
                                    <%--<telerik:RadTextBox ID="txt_InterfaceHandoff" runat="server">
                                    </telerik:RadTextBox>--%>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="cmbService" Enabled="false"  runat="server" Skin="Office2007"
                                        Width="202px" onselectedindexchanged="cmbService_SelectedIndexChanged" AutoPostBack="true">
                                    </telerik:RadComboBox>
                                </td>

                                <td align="right">
                                    <asp:Label ID="lblServiceType" runat="server" Visible="false" CssClass="lbl" Text="Service Type" Width="100px" />
                                </td>
                                <td>
                                ...
                                <%--<td align="right">
                                    <asp:Label ID="lbl_ConnectCommunication" runat="server" CssClass="lbl" Text="Connect Communication"
                                        Width="100px" />
                                </td>
                                <td>
                                    <telerik:RadTextBox ID="txt_ConnectCommunication"  runat="server">
                                    </telerik:RadTextBox>
                                </td>--%>
                                <%--<td align="right">
                                    <asp:Label ID="lbl_LastMileTopology" runat="server" CssClass="lbl" Text="Last Mile Topology"
                            ...
                            <tr>
                               <%-- <td align="right">
                                    <asp:Label ID="lbl_ServiceDescription" runat="server" CssClass="lbl" Text="Service Description"
                                        Width="100px" />
                                </td>
                                <td>
                                    <telerik:RadTextBox ID="txt_ServiceDescription"  Width="198px" runat="server">
                                    </telerik:RadTextBox>
                                </td>--%>
                                <td align="right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="cmbSLARequirement" runat="server" AutoPostBack="True" Width="202px">
                                        <Items>
                                            <%--<telerik:RadComboBoxItem runat="server" Selected="True" Text="Last Mile" Value="1" />
                                            <telerik:RadComboBoxItem runat="server" Text="Core Network" Value="2" />--%>
                            ...
                            <tr>
                            <td align="right">
                                    <asp:Label ID="lbl_LinkInformation" runat="server" CssClass="lbl" Visible="false" Text="Link Information"
                                        Width="100px" />
                                </td>
                                <td>
                                ...
                                <td align="right">
                                    <asp:Label ID="lbl_ConnectCommunication" Visible="false" runat="server" CssClass="lbl" Text="Connect Communication"
                                        Width="100px" />
                                </td>
                                <td>
                        ...
                        <table class="nav-justified">
                            ...
                            <td align="right">
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txtAdditionalRequirement" TextMode="MultiLine"  Width="986px" runat="server">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            </table>

                            <asp:Panel ID="pnlipcore" runat="server" Visible="false">
                            <table class="nav-justified">
                    <tr>
                <td bgcolor="#03828A" style="font-family: Calibri;  font-weight: bold; color: #FFFFFF">
                   IP Core Segments
                            ...
                            <td align="right">
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_ServiceDescription" TextMode="MultiLine"  Width="986px" runat="server">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                             ...
                             <tr>
                            <td align="right">
                                    <asp:Label ID="lblComments" runat="server" CssClass="lbl" Text="Comments"
                                        Width="100px" />
                                </td>
                                <td>
                            ...
                            <td align="right">
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txtAdditionalEquipment" TextMode="MultiLine"  Width="986px" runat="server">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
