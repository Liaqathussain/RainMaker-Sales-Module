<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="MapNRF.aspx.cs" Inherits="RainMaker.NRF.MapNRF" %>
        ...
        <div class="container-fluid">
            <div>
                ...
                <p>
                    ...
                    <input type="text" name="start" id="start" clientidmode="Static" style="width: 250px;" />
                    <label for="end">
                        Joints/Handhole:
                    </label>
                    ...
                    <input type="text" id="FirstCoordinatesLat" runat="server" clientidmode="Static"
                        style="width: 250px;" />
                    <input type="button" value="Calculate Route" runat="server" onclick="calcRoute()" />
                ...
                <p>
                    ...
                    <select id="cmbInfraType" name="infra[cmbInfraType]">
                    ...
                    <input type="button" value="Estimate" runat="server" onclick="Estimate_Click()" />
                </p>
                <p>
                </p>
                ...
                <%--<asp:GridView ID="grd_Coordinates" AutoGenerateColumns="true" runat="server">
                </asp:GridView>--%>
...
//            }
                ...
                //var url = "MapNRFCustomerCoordinates.aspx?Lat=" + LatCus;
                window.location.href = url;
        }
