...
{
    public partial class NRFItemsView : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt_NRFDetail.Rows.Count > 0)
            {
                ...
                txtCircuitName.Text = dt_NRFDetail.Rows[0]["BranchName"].ToString();
                txtSiteAddress.Text = dt_NRFDetail.Rows[0]["SiteAddress"].ToString();
                txtCity.Text = dt_NRFDetail.Rows[0]["City"].ToString();
                _City = dt_NRFDetail.Rows[0]["City"].ToString();
                cmbBuilding.SelectedValue = dt_NRFDetail.Rows[0]["Building"].ToString();
                cmbArea.SelectedValue = dt_NRFDetail.Rows[0]["AreaID"].ToString();
                cmbLOB.SelectedValue = dt_NRFDetail.Rows[0]["LOB"].ToString();
                ...
                txtPOCName.Text = dt_NRFDetail.Rows[0]["POCName"].ToString();
                txtPOCContact.Text = dt_NRFDetail.Rows[0]["POCContact"].ToString();
                txtPOCEmail.Text = dt_NRFDetail.Rows[0]["POCEmail"].ToString();
                cmbCapacity.SelectedValue = dt_NRFDetail.Rows[0]["Capacity"].ToString();
                cmbIndustry.SelectedValue = dt_NRFDetail.Rows[0]["Industry"].ToString();
                txtNRFType.Text = dt_NRFDetail.Rows[0]["InfraType"].ToString();
            }
            ...
            txtPOCName.ReadOnly = true;
            txtPOCContact.ReadOnly = true;
            txtPOCEmail.ReadOnly = true;
            cmbCapacity.Enabled = false;
            cmbIndustry.Enabled = false;
            ...
            {               
                ...
                DataTable dt = obj_NRFView.GetCustomerNRFDetail(_NRFID);
