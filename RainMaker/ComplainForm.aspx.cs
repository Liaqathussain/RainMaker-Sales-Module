...
namespace RainMaker
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    ComplainID = Convert.ToInt32(base.Request.QueryString["ComplainID"]);
                    Flag = base.Request.QueryString["Flag"].ToString();
                    Session["Complain_Flag"] = Flag;
                    Session["Complain_ComplainID"] = ComplainID;
                    ...
                    //DignoseFormSenerio(Session["Complain_Flag"].ToString(), Convert.ToInt32(Session["Complain_ComplainID"]));
        ...
        protected void cmbInitialStatement_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
        ...
        private void loadCircuitCompleteDetails(int SignupID)
        {
            try
            {
                ...
                if (dt.Rows.Count == 1)
                {
                    ...
                    {
                        rbVOIP.SelectedIndex = 0; //YES
                    }
                    else
                    {
                        rbVOIP.SelectedIndex = 1;  //NO
                    }

                    if (dt.Rows[0]["VC"] == "YES")
                    {
                        rbVideo.SelectedIndex = 0;  //YES
                    }
                    else
                    {
                        rbVideo.SelectedIndex = 1;  //NO
                    }
        ...
        public string GetRemarksfromControls()
        {
            try
            {
                ...
                {
                    RadTextBox tbTS12_5Remarks = (RadTextBox)cntIntial_LinkDownDrops.FindControl("tbTS12_5Remarks");
                    return tbTS12_5Remarks.Text;

                }
                else if (cmbInitialStatement.SelectedValue == "5" || cmbInitialStatement.SelectedValue == "4")
                {
                    RadTextBox tbTS23_5Remarks = (RadTextBox)cntIntial_LinkDownDrops.FindControl("tbTS23_5Remarks");
                    return tbTS23_5Remarks.Text;

                }
                else if (cmbInitialStatement.SelectedValue == "6")
                {
                    RadTextBox tbTS31_8Remarks = (RadTextBox)cntIntial_LinkDownDrops.FindControl("tbTS31_8Remarks");
                    return tbTS31_8Remarks.Text;

                }
                else if (cmbInitialStatement.SelectedValue == "7")
                {
                    RadTextBox tbTS41_4Remarks = (RadTextBox)cntIntial_LinkDownDrops.FindControl("tbTS41_4Remarks");
                    return tbTS41_4Remarks.Text;

                }
                else if (cmbInitialStatement.SelectedValue == "8" | cmbInitialStatement.SelectedValue == "9")
                {
                    RadTextBox tbTS51_2Remarks = (RadTextBox)cntIntial_LinkDownDrops.FindControl("tbTS51_2Remarks");
        ...
        protected void btSaveComplain_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string AssignedPersonName = lblEngineerName.Text;
        ...
        protected void cmbComplainStatus_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            try
            {
