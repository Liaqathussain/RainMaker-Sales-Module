<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateCustContact.aspx.cs" Inherits="RainMaker.WebForm12" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="style1">
        ...
        <td class="style6" colspan="7"><telerik:RadButton ID="btnSave" OnClick="btnSave_Click" Text="Save Record" runat="server"></telerik:RadButton></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
